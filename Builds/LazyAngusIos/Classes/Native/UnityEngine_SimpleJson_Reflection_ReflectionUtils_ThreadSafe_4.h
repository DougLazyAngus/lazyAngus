...
struct ThreadSafeDictionaryValueFactory_2_t2889;
...
struct  ThreadSafeDictionary_2_t2890  : public Object_t
{
	...
	ThreadSafeDictionaryValueFactory_2_t2889 * ____valueFactory_1;
	...
	Dictionary_2_t8435 * ____dictionary_2;
};
