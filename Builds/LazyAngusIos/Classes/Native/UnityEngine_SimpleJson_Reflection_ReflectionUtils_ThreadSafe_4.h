...
struct  ThreadSafeDictionary_2_t1242  : public Object_t
{
	...
	ThreadSafeDictionaryValueFactory_2_t1241 * ____valueFactory_1;
	...
	Dictionary_2_t3921 * ____dictionary_2;
};
