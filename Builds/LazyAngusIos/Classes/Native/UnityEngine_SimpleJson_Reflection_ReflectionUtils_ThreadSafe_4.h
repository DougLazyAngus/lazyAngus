...
struct  ThreadSafeDictionary_2_t1321  : public Object_t
{
	...
	ThreadSafeDictionaryValueFactory_2_t1320 * ____valueFactory_1;
	...
	Dictionary_2_t4015 * ____dictionary_2;
};
