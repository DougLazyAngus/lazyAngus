...
struct  ThreadSafeDictionary_2_t2880  : public Object_t
{
	...
	ThreadSafeDictionaryValueFactory_2_t2879 * ____valueFactory_1;
	...
	Dictionary_2_t8424 * ____dictionary_2;
};
