...
struct  ThreadSafeDictionary_2_t2960  : public Object_t
{
	...
	ThreadSafeDictionaryValueFactory_2_t2959 * ____valueFactory_1;
	...
	Dictionary_2_t9083 * ____dictionary_2;
};
