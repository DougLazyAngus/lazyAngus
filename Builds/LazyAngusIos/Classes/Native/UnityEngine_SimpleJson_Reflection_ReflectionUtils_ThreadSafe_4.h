...
struct ThreadSafeDictionaryValueFactory_2_t1276;
...
struct  ThreadSafeDictionary_2_t1277  : public Object_t
{
	...
	ThreadSafeDictionaryValueFactory_2_t1276 * ____valueFactory_1;
	...
	Dictionary_2_t3949 * ____dictionary_2;
};
