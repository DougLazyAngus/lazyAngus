...
struct  ThreadSafeDictionary_2_t1220  : public Object_t
{
	...
	ThreadSafeDictionaryValueFactory_2_t1219 * ____valueFactory_1;
	...
	Dictionary_2_t3897 * ____dictionary_2;
};
