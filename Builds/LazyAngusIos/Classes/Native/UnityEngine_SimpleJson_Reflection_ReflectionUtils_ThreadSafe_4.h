...
struct  ThreadSafeDictionary_2_t1322  : public Object_t
{
	...
	ThreadSafeDictionaryValueFactory_2_t1321 * ____valueFactory_1;
	...
	Dictionary_2_t4016 * ____dictionary_2;
};
