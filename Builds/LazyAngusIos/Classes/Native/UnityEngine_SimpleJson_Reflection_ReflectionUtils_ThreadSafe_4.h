...
struct  ThreadSafeDictionary_2_t2889  : public Object_t
{
	...
	ThreadSafeDictionaryValueFactory_2_t2888 * ____valueFactory_1;
	...
	Dictionary_2_t8434 * ____dictionary_2;
};
