...
struct  ThreadSafeDictionary_2_t2956  : public Object_t
{
	...
	ThreadSafeDictionaryValueFactory_2_t2955 * ____valueFactory_1;
	...
	Dictionary_2_t8542 * ____dictionary_2;
};
