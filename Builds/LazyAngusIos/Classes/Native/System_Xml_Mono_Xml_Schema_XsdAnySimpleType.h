...
// Mono.Xml.Schema.XsdAnySimpleType
struct  XsdAnySimpleType_t3051  : public XmlSchemaDatatype_t3052
{
};
struct XsdAnySimpleType_t3051_StaticFields{
	// Mono.Xml.Schema.XsdAnySimpleType Mono.Xml.Schema.XsdAnySimpleType::instance
	XsdAnySimpleType_t3051 * ___instance_55;
	// System.Char[] Mono.Xml.Schema.XsdAnySimpleType::whitespaceArray
	CharU5BU5D_t662* ___whitespaceArray_56;
