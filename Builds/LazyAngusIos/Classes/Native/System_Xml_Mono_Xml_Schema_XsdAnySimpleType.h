...
// Mono.Xml.Schema.XsdAnySimpleType
struct  XsdAnySimpleType_t1922  : public XmlSchemaDatatype_t1923
{
};
struct XsdAnySimpleType_t1922_StaticFields{
	// Mono.Xml.Schema.XsdAnySimpleType Mono.Xml.Schema.XsdAnySimpleType::instance
	XsdAnySimpleType_t1922 * ___instance_55;
	// System.Char[] Mono.Xml.Schema.XsdAnySimpleType::whitespaceArray
	CharU5BU5D_t555* ___whitespaceArray_56;
