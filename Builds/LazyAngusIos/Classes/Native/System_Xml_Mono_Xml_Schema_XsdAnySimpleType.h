...
// Mono.Xml.Schema.XsdAnySimpleType
struct  XsdAnySimpleType_t3049  : public XmlSchemaDatatype_t3050
{
};
struct XsdAnySimpleType_t3049_StaticFields{
	// Mono.Xml.Schema.XsdAnySimpleType Mono.Xml.Schema.XsdAnySimpleType::instance
	XsdAnySimpleType_t3049 * ___instance_55;
	// System.Char[] Mono.Xml.Schema.XsdAnySimpleType::whitespaceArray
	CharU5BU5D_t660* ___whitespaceArray_56;
