...
// Mono.Xml.Schema.XsdAnySimpleType
struct  XsdAnySimpleType_t1493  : public XmlSchemaDatatype_t1494
{
};
struct XsdAnySimpleType_t1493_StaticFields{
	// Mono.Xml.Schema.XsdAnySimpleType Mono.Xml.Schema.XsdAnySimpleType::instance
	XsdAnySimpleType_t1493 * ___instance_55;
	// System.Char[] Mono.Xml.Schema.XsdAnySimpleType::whitespaceArray
	CharU5BU5D_t607* ___whitespaceArray_56;
