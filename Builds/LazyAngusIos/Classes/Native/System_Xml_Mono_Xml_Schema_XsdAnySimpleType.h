...
// Mono.Xml.Schema.XsdAnySimpleType
struct  XsdAnySimpleType_t3050  : public XmlSchemaDatatype_t3051
{
};
struct XsdAnySimpleType_t3050_StaticFields{
	// Mono.Xml.Schema.XsdAnySimpleType Mono.Xml.Schema.XsdAnySimpleType::instance
	XsdAnySimpleType_t3050 * ___instance_55;
	// System.Char[] Mono.Xml.Schema.XsdAnySimpleType::whitespaceArray
	CharU5BU5D_t661* ___whitespaceArray_56;
