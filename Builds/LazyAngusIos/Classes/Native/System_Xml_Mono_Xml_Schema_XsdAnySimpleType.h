...
// Mono.Xml.Schema.XsdAnySimpleType
struct  XsdAnySimpleType_t3040  : public XmlSchemaDatatype_t3041
{
};
struct XsdAnySimpleType_t3040_StaticFields{
	// Mono.Xml.Schema.XsdAnySimpleType Mono.Xml.Schema.XsdAnySimpleType::instance
	XsdAnySimpleType_t3040 * ___instance_55;
	// System.Char[] Mono.Xml.Schema.XsdAnySimpleType::whitespaceArray
	CharU5BU5D_t653* ___whitespaceArray_56;
