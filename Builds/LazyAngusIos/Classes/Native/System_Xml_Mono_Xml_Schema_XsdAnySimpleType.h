...
// Mono.Xml.Schema.XsdAnySimpleType
struct  XsdAnySimpleType_t1899  : public XmlSchemaDatatype_t1900
{
};
struct XsdAnySimpleType_t1899_StaticFields{
	// Mono.Xml.Schema.XsdAnySimpleType Mono.Xml.Schema.XsdAnySimpleType::instance
	XsdAnySimpleType_t1899 * ___instance_55;
	// System.Char[] Mono.Xml.Schema.XsdAnySimpleType::whitespaceArray
	CharU5BU5D_t536* ___whitespaceArray_56;
