...
// Mono.Xml.Schema.XsdAnySimpleType
struct  XsdAnySimpleType_t3039  : public XmlSchemaDatatype_t3040
{
};
struct XsdAnySimpleType_t3039_StaticFields{
	// Mono.Xml.Schema.XsdAnySimpleType Mono.Xml.Schema.XsdAnySimpleType::instance
	XsdAnySimpleType_t3039 * ___instance_55;
	// System.Char[] Mono.Xml.Schema.XsdAnySimpleType::whitespaceArray
	CharU5BU5D_t652* ___whitespaceArray_56;
