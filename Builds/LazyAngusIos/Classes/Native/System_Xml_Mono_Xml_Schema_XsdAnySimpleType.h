...
// Mono.Xml.Schema.XsdAnySimpleType
struct  XsdAnySimpleType_t1877  : public XmlSchemaDatatype_t1878
{
};
struct XsdAnySimpleType_t1877_StaticFields{
	// Mono.Xml.Schema.XsdAnySimpleType Mono.Xml.Schema.XsdAnySimpleType::instance
	XsdAnySimpleType_t1877 * ___instance_55;
	// System.Char[] Mono.Xml.Schema.XsdAnySimpleType::whitespaceArray
	CharU5BU5D_t512* ___whitespaceArray_56;
