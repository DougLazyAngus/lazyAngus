...
struct  X509Store_t4053  : public Object_t
{
	...
	X509Certificate2Collection_t4046 * ___list_2;
	...
	X509Store_t3774 * ___store_4;
};
struct X509Store_t4053_StaticFields{
	...
	Dictionary_2_t223 * ___U3CU3Ef__switchU24mapF_5;
};
