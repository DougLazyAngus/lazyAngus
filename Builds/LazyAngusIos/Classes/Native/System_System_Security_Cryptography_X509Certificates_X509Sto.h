...
struct  X509Store_t2090  : public Object_t
{
	...
	X509Certificate2Collection_t2083 * ___list_2;
	...
	X509Store_t1768 * ___store_4;
};
struct X509Store_t2090_StaticFields{
	...
	Dictionary_2_t183 * ___U3CU3Ef__switchU24mapF_5;
};
