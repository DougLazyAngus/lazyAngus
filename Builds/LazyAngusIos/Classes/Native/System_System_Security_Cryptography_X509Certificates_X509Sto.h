...
struct  X509Store_t4450  : public Object_t
{
	...
	X509Certificate2Collection_t4442 * ___list_2;
	...
	X509Store_t3160 * ___store_4;
};
struct X509Store_t4450_StaticFields{
	...
	Dictionary_2_t223 * ___U3CU3Ef__switchU24map1B_5;
};
