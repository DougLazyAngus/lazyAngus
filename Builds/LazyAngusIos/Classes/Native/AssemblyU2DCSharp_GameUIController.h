...
// GameUIController
struct  GameUIController_t515  : public MonoBehaviour_t13
{
...
struct GameUIController_t515_StaticFields{
	// GameUIController GameUIController::<instance>k__BackingField
	GameUIController_t515 * ___U3CinstanceU3Ek__BackingField_8;
};
