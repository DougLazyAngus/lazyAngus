...
// GameUIController
struct  GameUIController_t520  : public MonoBehaviour_t13
{
...
struct GameUIController_t520_StaticFields{
	// GameUIController GameUIController::<instance>k__BackingField
	GameUIController_t520 * ___U3CinstanceU3Ek__BackingField_8;
};
