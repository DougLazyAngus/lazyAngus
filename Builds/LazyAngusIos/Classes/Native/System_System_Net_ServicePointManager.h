...
struct  ServicePointManager_t1874  : public Object_t
{
};
struct ServicePointManager_t1874_StaticFields{
	// System.Collections.Specialized.HybridDictionary System.Net.ServicePointManager::servicePoints
	HybridDictionary_t1938 * ___servicePoints_0;
	...
	RemoteCertificateValidationCallback_t1882 * ___server_cert_cb_9;
};
