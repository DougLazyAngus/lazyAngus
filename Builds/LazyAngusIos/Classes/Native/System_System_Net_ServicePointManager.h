...
struct ICertificatePolicy_t1580;
...
struct  ServicePointManager_t1581  : public Object_t
{
};
struct ServicePointManager_t1581_StaticFields{
	// System.Collections.Specialized.HybridDictionary System.Net.ServicePointManager::servicePoints
	HybridDictionary_t1448 * ___servicePoints_0;
	...
	RemoteCertificateValidationCallback_t1482 * ___server_cert_cb_9;
};
