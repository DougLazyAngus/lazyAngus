...
struct  ServicePointManager_t3925  : public Object_t
{
};
struct ServicePointManager_t3925_StaticFields{
	// System.Collections.Specialized.HybridDictionary System.Net.ServicePointManager::servicePoints
	HybridDictionary_t3954 * ___servicePoints_0;
	...
	RemoteCertificateValidationCallback_t3933 * ___server_cert_cb_9;
};
