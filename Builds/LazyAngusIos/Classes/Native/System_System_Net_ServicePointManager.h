...
struct ICertificatePolicy_t1570;
...
struct  ServicePointManager_t1571  : public Object_t
{
};
struct ServicePointManager_t1571_StaticFields{
	// System.Collections.Specialized.HybridDictionary System.Net.ServicePointManager::servicePoints
	HybridDictionary_t1438 * ___servicePoints_0;
	...
	RemoteCertificateValidationCallback_t1472 * ___server_cert_cb_9;
};
