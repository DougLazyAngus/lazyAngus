...
struct  ServicePointManager_t3944  : public Object_t
{
};
struct ServicePointManager_t3944_StaticFields{
	// System.Collections.Specialized.HybridDictionary System.Net.ServicePointManager::servicePoints
	HybridDictionary_t3973 * ___servicePoints_0;
	...
	RemoteCertificateValidationCallback_t3952 * ___server_cert_cb_9;
};
