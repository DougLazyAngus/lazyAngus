...
// Parse.ParseConfig
struct  ParseConfig_t1183  : public Object_t
{
...
struct ParseConfig_t1183_StaticFields{
	...
	ParseConfig_t1183 * ___currentConfig_1;
	// Parse.Internal.TaskQueue Parse.ParseConfig::taskQueue
	TaskQueue_t1159 * ___taskQueue_2;
	...
	Func_2_t1184 * ___CSU24U3CU3E9__CachedAnonymousMethodDelegate5_4;
};
