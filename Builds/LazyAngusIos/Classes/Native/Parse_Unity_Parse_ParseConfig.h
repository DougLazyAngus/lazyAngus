...
// Parse.ParseConfig
struct  ParseConfig_t1233  : public Object_t
{
...
struct ParseConfig_t1233_StaticFields{
	...
	ParseConfig_t1233 * ___currentConfig_1;
	// Parse.Internal.TaskQueue Parse.ParseConfig::taskQueue
	TaskQueue_t1209 * ___taskQueue_2;
	...
	Func_2_t1234 * ___CSU24U3CU3E9__CachedAnonymousMethodDelegate5_4;
};
