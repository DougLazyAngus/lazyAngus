...
// Parse.ParseConfig
struct  ParseConfig_t1182  : public Object_t
{
...
struct ParseConfig_t1182_StaticFields{
	...
	ParseConfig_t1182 * ___currentConfig_1;
	// Parse.Internal.TaskQueue Parse.ParseConfig::taskQueue
	TaskQueue_t1158 * ___taskQueue_2;
	...
	Func_2_t1183 * ___CSU24U3CU3E9__CachedAnonymousMethodDelegate5_4;
};
