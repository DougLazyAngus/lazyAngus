...
// Parse.ParseConfig
struct  ParseConfig_t1253  : public Object_t
{
...
struct ParseConfig_t1253_StaticFields{
	...
	ParseConfig_t1253 * ___currentConfig_1;
	// Parse.Internal.TaskQueue Parse.ParseConfig::taskQueue
	TaskQueue_t1229 * ___taskQueue_2;
	...
	Func_2_t1254 * ___CSU24U3CU3E9__CachedAnonymousMethodDelegate5_4;
};
