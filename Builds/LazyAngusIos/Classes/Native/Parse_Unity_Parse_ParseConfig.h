...
// Parse.ParseConfig
struct  ParseConfig_t1235  : public Object_t
{
...
struct ParseConfig_t1235_StaticFields{
	...
	ParseConfig_t1235 * ___currentConfig_1;
	// Parse.Internal.TaskQueue Parse.ParseConfig::taskQueue
	TaskQueue_t1211 * ___taskQueue_2;
	...
	Func_2_t1236 * ___CSU24U3CU3E9__CachedAnonymousMethodDelegate5_4;
};
