...
// Parse.ParseConfig
struct  ParseConfig_t1184  : public Object_t
{
...
struct ParseConfig_t1184_StaticFields{
	...
	ParseConfig_t1184 * ___currentConfig_1;
	// Parse.Internal.TaskQueue Parse.ParseConfig::taskQueue
	TaskQueue_t1160 * ___taskQueue_2;
	...
	Func_2_t1185 * ___CSU24U3CU3E9__CachedAnonymousMethodDelegate5_4;
};
