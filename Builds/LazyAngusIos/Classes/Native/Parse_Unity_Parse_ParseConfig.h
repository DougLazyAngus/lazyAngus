...
// Parse.ParseConfig
struct  ParseConfig_t1252  : public Object_t
{
...
struct ParseConfig_t1252_StaticFields{
	...
	ParseConfig_t1252 * ___currentConfig_1;
	// Parse.Internal.TaskQueue Parse.ParseConfig::taskQueue
	TaskQueue_t1228 * ___taskQueue_2;
	...
	Func_2_t1253 * ___CSU24U3CU3E9__CachedAnonymousMethodDelegate5_4;
};
