...
// InputHandler
struct  InputHandler_t441  : public MonoBehaviour_t67
{
	// UnityEngine.Camera InputHandler::worldCamera
	Camera_t440 * ___worldCamera_4;
	// UnityEngine.Camera InputHandler::uxCamera
	Camera_t440 * ___uxCamera_5;
...
struct InputHandler_t441_StaticFields{
	...
	InputHandler_t441 * ___U3CinstanceU3Ek__BackingField_8;
};
