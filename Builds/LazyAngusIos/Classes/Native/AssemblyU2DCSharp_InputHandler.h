...
// InputHandler
struct  InputHandler_t531  : public MonoBehaviour_t13
{
	// UnityEngine.Camera InputHandler::worldCamera
	Camera_t530 * ___worldCamera_4;
	// UnityEngine.Camera InputHandler::uxCamera
	Camera_t530 * ___uxCamera_5;
...
struct InputHandler_t531_StaticFields{
	...
	InputHandler_t531 * ___U3CinstanceU3Ek__BackingField_8;
};
