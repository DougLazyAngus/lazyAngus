...
// InputHandler
struct  InputHandler_t478  : public MonoBehaviour_t67
{
	// UnityEngine.Camera InputHandler::worldCamera
	Camera_t477 * ___worldCamera_4;
	// UnityEngine.Camera InputHandler::uxCamera
	Camera_t477 * ___uxCamera_5;
...
struct InputHandler_t478_StaticFields{
	...
	InputHandler_t478 * ___U3CinstanceU3Ek__BackingField_8;
};
