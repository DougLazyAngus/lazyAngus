...
struct  List_1_t3568  : public Object_t
{
	// T[] System.Collections.Generic.List`1<MouseHole/MouseHoleLocation>::_items
	MouseHoleLocationU5BU5D_t615* ____items_1;
...
struct List_1_t3568_StaticFields{
	// T[] System.Collections.Generic.List`1<MouseHole/MouseHoleLocation>::EmptyArray
	MouseHoleLocationU5BU5D_t615* ___EmptyArray_4;
};
