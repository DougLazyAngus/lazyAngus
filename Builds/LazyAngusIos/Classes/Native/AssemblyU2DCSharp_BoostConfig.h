...
// BoostConfig
struct  BoostConfig_t414  : public MonoBehaviour_t67
{
	// BoostDesc[] BoostConfig::boostDescs
	BoostDescU5BU5D_t429* ___boostDescs_2;
