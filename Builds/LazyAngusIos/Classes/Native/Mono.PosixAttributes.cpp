...
void g_Mono_Posix_Assembly_CustomAttributesCacheGenerator(CustomAttributesCache* cache)
{
	...
	cache->attributes = (Il2CppObject**)il2cpp_gc_alloc_fixed(sizeof(Object_t *) * cache->count, 0);
	{
		...
		AssemblyTitleAttribute__ctor_m6364(tmp, il2cpp_codegen_string_new_wrapper("Mono.Posix.dll"), NULL);
	...
	}
	{
		...
		AssemblyDescriptionAttribute__ctor_m6358(tmp, il2cpp_codegen_string_new_wrapper("Unix Integration Classes"), NULL);
