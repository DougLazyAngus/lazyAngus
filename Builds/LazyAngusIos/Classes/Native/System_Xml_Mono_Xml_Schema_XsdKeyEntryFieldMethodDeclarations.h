...
extern "C" void XsdKeyEntryField__ctor_m12246 (XsdKeyEntryField_t3411 * __this, XsdKeyEntry_t3409 * ___entry, XsdIdentityField_t3405 * ___field, const MethodInfo* method) IL2CPP_METHOD_ATTR;
...
extern "C" bool XsdKeyEntryField_SetIdentityField_m12247 (XsdKeyEntryField_t3411 * __this, Object_t * ___identity, bool ___isXsiNil, XsdAnySimpleType_t3410 * ___type, int32_t ___depth, Object_t * ___li, const MethodInfo* method) IL2CPP_METHOD_ATTR;
...
extern "C" XsdIdentityPath_t3407 * XsdKeyEntryField_Matches_m12248 (XsdKeyEntryField_t3411 * __this, bool ___matchesAttr, Object_t * ___sender, XmlNameTable_t3459 * ___nameTable, ArrayList_t713 * ___qnameStack, String_t* ___sourceUri, Object_t * ___schemaType, Object_t * ___nsResolver, Object_t * ___lineInfo, int32_t ___depth, String_t* ___attrName, String_t* ___attrNS, Object_t * ___attrValue, const MethodInfo* method) IL2CPP_METHOD_ATTR;
