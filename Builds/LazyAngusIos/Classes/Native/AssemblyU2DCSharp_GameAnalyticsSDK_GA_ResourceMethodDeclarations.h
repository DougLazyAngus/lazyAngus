...
extern "C" void GA_Resource_NewEvent_m2613 (Object_t * __this /* static, unused */, int32_t ___flowType, String_t* ___currency, float ___amount, String_t* ___itemType, String_t* ___itemId, const MethodInfo* method) IL2CPP_METHOD_ATTR;
