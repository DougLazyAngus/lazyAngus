...
// GamePhaseState
struct  GamePhaseState_t516  : public MonoBehaviour_t13
{
...
struct GamePhaseState_t516_StaticFields{
	// GamePhaseState GamePhaseState::<instance>k__BackingField
	GamePhaseState_t516 * ___U3CinstanceU3Ek__BackingField_12;
};
