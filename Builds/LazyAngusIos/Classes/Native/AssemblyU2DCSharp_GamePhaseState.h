...
// GamePhaseState
struct  GamePhaseState_t517  : public MonoBehaviour_t13
{
	...
	GameInstanceChangedEventHandler_t515 * ___GameInstanceChanged_7;
	// GamePhaseState/GamePhaseChangedEventHandler GamePhaseState::GamePhaseChanged
	GamePhaseChangedEventHandler_t516 * ___GamePhaseChanged_8;
...
struct GamePhaseState_t517_StaticFields{
	// GamePhaseState GamePhaseState::<instance>k__BackingField
	GamePhaseState_t517 * ___U3CinstanceU3Ek__BackingField_12;
};
