...
struct  ThreadSafeDictionary_2_t2952  : public Object_t
{
	...
	ThreadSafeDictionaryValueFactory_2_t2951 * ____valueFactory_1;
	...
	Dictionary_2_t9068 * ____dictionary_2;
};
