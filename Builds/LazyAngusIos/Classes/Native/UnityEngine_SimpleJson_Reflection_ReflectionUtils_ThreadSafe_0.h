...
struct  ThreadSafeDictionary_2_t2877  : public Object_t
{
	...
	ThreadSafeDictionaryValueFactory_2_t2876 * ____valueFactory_1;
	...
	Dictionary_2_t8416 * ____dictionary_2;
};
