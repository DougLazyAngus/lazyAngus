...
struct  ThreadSafeDictionary_2_t2933  : public Object_t
{
	...
	ThreadSafeDictionaryValueFactory_2_t2932 * ____valueFactory_1;
	...
	Dictionary_2_t8501 * ____dictionary_2;
};
