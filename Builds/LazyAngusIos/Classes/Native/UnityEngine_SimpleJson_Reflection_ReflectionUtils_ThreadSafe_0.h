...
struct  ThreadSafeDictionary_2_t1317  : public Object_t
{
	...
	ThreadSafeDictionaryValueFactory_2_t1316 * ____valueFactory_1;
	...
	Dictionary_2_t4005 * ____dictionary_2;
};
