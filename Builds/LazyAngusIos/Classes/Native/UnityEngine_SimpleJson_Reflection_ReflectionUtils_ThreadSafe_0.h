...
struct  ThreadSafeDictionary_2_t2963  : public Object_t
{
	...
	ThreadSafeDictionaryValueFactory_2_t2962 * ____valueFactory_1;
	...
	Dictionary_2_t9081 * ____dictionary_2;
};
