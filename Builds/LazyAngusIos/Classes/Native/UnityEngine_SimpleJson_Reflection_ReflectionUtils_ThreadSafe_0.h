...
struct  ThreadSafeDictionary_2_t1238  : public Object_t
{
	...
	ThreadSafeDictionaryValueFactory_2_t1237 * ____valueFactory_1;
	...
	Dictionary_2_t3911 * ____dictionary_2;
};
