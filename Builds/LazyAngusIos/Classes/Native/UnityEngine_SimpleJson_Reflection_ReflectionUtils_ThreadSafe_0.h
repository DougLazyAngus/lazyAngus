...
struct  ThreadSafeDictionary_2_t2883  : public Object_t
{
	...
	ThreadSafeDictionaryValueFactory_2_t2882 * ____valueFactory_1;
	...
	Dictionary_2_t8423 * ____dictionary_2;
};
