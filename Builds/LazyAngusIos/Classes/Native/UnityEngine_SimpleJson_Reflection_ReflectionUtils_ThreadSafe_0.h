...
struct  ThreadSafeDictionary_2_t1265  : public Object_t
{
	...
	ThreadSafeDictionaryValueFactory_2_t1264 * ____valueFactory_1;
	...
	Dictionary_2_t3930 * ____dictionary_2;
};
