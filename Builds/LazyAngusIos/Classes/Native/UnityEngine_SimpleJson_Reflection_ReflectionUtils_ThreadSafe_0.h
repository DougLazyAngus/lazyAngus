...
struct  ThreadSafeDictionary_2_t1273  : public Object_t
{
	...
	ThreadSafeDictionaryValueFactory_2_t1272 * ____valueFactory_1;
	...
	Dictionary_2_t3939 * ____dictionary_2;
};
