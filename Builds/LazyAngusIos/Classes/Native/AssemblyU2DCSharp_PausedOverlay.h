...
// PausedOverlay
struct  PausedOverlay_t618  : public MonoBehaviour_t13
{
	...
	Button_t501 * ___bigPlayButton_4;
...
struct PausedOverlay_t618_StaticFields{
	// PausedOverlay PausedOverlay::instance
	PausedOverlay_t618 * ___instance_2;
};
