...
// PausedOverlay
struct  PausedOverlay_t556  : public MonoBehaviour_t13
{
	...
	Button_t526 * ___bigPlayButton_4;
...
struct PausedOverlay_t556_StaticFields{
	// PausedOverlay PausedOverlay::instance
	PausedOverlay_t556 * ___instance_2;
};
