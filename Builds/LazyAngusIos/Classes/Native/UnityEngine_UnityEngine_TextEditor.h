...
struct  TextEditor_t909  : public Object_t
{
	// UnityEngine.TouchScreenKeyboard UnityEngine.TextEditor::keyboardOnScreen
	TouchScreenKeyboard_t782 * ___keyboardOnScreen_0;
...
struct TextEditor_t909_StaticFields{
	...
	Dictionary_2_t1202 * ___s_Keyactions_23;
};
