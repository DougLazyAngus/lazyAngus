...
struct  TextEditor_t1007  : public Object_t
{
	// UnityEngine.TouchScreenKeyboard UnityEngine.TextEditor::keyboardOnScreen
	TouchScreenKeyboard_t880 * ___keyboardOnScreen_0;
...
struct TextEditor_t1007_StaticFields{
	...
	Dictionary_2_t2822 * ___s_Keyactions_23;
};
