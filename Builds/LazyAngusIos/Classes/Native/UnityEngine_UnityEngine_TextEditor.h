...
struct  TextEditor_t1102  : public Object_t
{
	// UnityEngine.TouchScreenKeyboard UnityEngine.TextEditor::keyboardOnScreen
	TouchScreenKeyboard_t974 * ___keyboardOnScreen_0;
...
struct TextEditor_t1102_StaticFields{
	...
	Dictionary_2_t2908 * ___s_Keyactions_23;
};
