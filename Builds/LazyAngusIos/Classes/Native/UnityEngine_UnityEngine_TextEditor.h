...
struct  TextEditor_t910  : public Object_t
{
	// UnityEngine.TouchScreenKeyboard UnityEngine.TextEditor::keyboardOnScreen
	TouchScreenKeyboard_t783 * ___keyboardOnScreen_0;
...
struct TextEditor_t910_StaticFields{
	...
	Dictionary_2_t1204 * ___s_Keyactions_23;
};
