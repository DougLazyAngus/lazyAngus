...
struct  TextEditor_t1091  : public Object_t
{
	// UnityEngine.TouchScreenKeyboard UnityEngine.TextEditor::keyboardOnScreen
	TouchScreenKeyboard_t963 * ___keyboardOnScreen_0;
...
struct TextEditor_t1091_StaticFields{
	...
	Dictionary_2_t2897 * ___s_Keyactions_23;
};
