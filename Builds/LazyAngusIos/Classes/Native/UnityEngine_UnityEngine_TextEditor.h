...
struct  TextEditor_t918  : public Object_t
{
	// UnityEngine.TouchScreenKeyboard UnityEngine.TextEditor::keyboardOnScreen
	TouchScreenKeyboard_t791 * ___keyboardOnScreen_0;
...
struct TextEditor_t918_StaticFields{
	...
	Dictionary_2_t1212 * ___s_Keyactions_23;
};
