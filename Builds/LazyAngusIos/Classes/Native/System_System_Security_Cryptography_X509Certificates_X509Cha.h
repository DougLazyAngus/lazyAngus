...
struct X509ChainElementCollection_t4049;
...
struct  X509Chain_t3891  : public Object_t
{
	...
	X509ChainElementCollection_t4049 * ___elements_1;
	...
	X509ChainPolicy_t4050 * ___policy_2;
	...
	X509ChainStatusU5BU5D_t4051* ___status_3;
	...
	X500DistinguishedName_t4042 * ___working_issuer_name_6;
	...
	AsymmetricAlgorithm_t3854 * ___working_public_key_7;
	...
	X509Certificate2Collection_t4047 * ___collection_11;
};
struct X509Chain_t3891_StaticFields{
	...
	X509ChainStatusU5BU5D_t4051* ___Empty_4;
