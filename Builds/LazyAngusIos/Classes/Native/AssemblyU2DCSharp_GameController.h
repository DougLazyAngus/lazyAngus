...
// GameController
struct  GameController_t505  : public MonoBehaviour_t13
{
	...
	MouseHoleU5BU5D_t503* ___mouseHoles_5;
	// MouseSpawnFromData GameController::mouseSpawnFromData
	MouseSpawnFromData_t504 * ___mouseSpawnFromData_6;
...
struct GameController_t505_StaticFields{
	// GameController GameController::<instance>k__BackingField
	GameController_t505 * ___U3CinstanceU3Ek__BackingField_9;
