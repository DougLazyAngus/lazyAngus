...
// GameController
struct  GameController_t424  : public MonoBehaviour_t67
{
	...
	MouseHoleU5BU5D_t422* ___mouseHoles_5;
	// MouseSpawnFromData GameController::mouseSpawnFromData
	MouseSpawnFromData_t423 * ___mouseSpawnFromData_6;
...
struct GameController_t424_StaticFields{
	// GameController GameController::<instance>k__BackingField
	GameController_t424 * ___U3CinstanceU3Ek__BackingField_9;
