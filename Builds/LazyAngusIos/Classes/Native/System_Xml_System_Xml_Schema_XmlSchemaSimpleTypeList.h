...
struct  XmlSchemaSimpleTypeList_t3695  : public XmlSchemaSimpleTypeContent_t3694
{
	...
	XmlSchemaSimpleType_t3644 * ___validatedListItemSchemaType_20;
};
