...
// TW_OAuthAPIRequest
struct  TW_OAuthAPIRequest_t290  : public MonoBehaviour_t67
{
	// System.Action`1<TW_APIRequstResult> TW_OAuthAPIRequest::OnResult
	Action_1_t294 * ___OnResult_2;
	...
	SortedDictionary_2_t295 * ___requestParams_7;
};
struct TW_OAuthAPIRequest_t290_StaticFields{
	// System.Action`1<TW_APIRequstResult> TW_OAuthAPIRequest::<>f__am$cache6
	Action_1_t294 * ___U3CU3Ef__amU24cache6_8;
};
