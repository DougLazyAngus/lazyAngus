...
// PlayerStats
struct  PlayerStats_t509  : public MonoBehaviour_t13
{
	...
	ScoreChangedEventHandler_t679 * ___ScoreChanged_6;
	// PlayerStats/MoneyChangedEventHandler PlayerStats::MoneyChanged
	MoneyChangedEventHandler_t680 * ___MoneyChanged_7;
	// PlayerStats/BoostsChangedEventHandler PlayerStats::BoostsChanged
	BoostsChangedEventHandler_t681 * ___BoostsChanged_8;
...
struct PlayerStats_t509_StaticFields{
	// PlayerStats PlayerStats::<instance>k__BackingField
	PlayerStats_t509 * ___U3CinstanceU3Ek__BackingField_11;
};
