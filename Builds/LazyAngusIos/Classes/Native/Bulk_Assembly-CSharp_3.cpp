...
extern "C" void LevelConfig_AddExplicitMouseDesc_m2906 (LevelConfig_t550 * __this, List_1_t537 ** ___retVal, float ___pause, bool ___isClockwise, int32_t ___location, int32_t ___mType, int32_t ___track, int32_t ___wType, const MethodInfo* method)
{
	static bool s_Il2CppMethodIntialized;
	if (!s_Il2CppMethodIntialized)
	{
...
IL_008c:
	...
	}
	{
		...
		LevelConfig_AddExplicitMouseDesc_m2906(__this, L_37, (3.0f), 0, 1, 0, 0, 0, /*hidden argument*/NULL);
		LevelDescription_t543 * L_38 = V_0;
		NullCheck(L_38);
		List_1_t537 ** L_39 = &(L_38->___explicitMouseDescs_1);
		LevelConfig_AddExplicitMouseDesc_m2906(__this, L_39, (1.5f), 0, 0, 0, 0, 0, /*hidden argument*/NULL);
		LevelDescription_t543 * L_40 = V_0;
		NullCheck(L_40);
		List_1_t537 ** L_41 = &(L_40->___explicitMouseDescs_1);
		LevelConfig_AddExplicitMouseDesc_m2906(__this, L_41, (4.0f), 1, 1, 0, 1, 0, /*hidden argument*/NULL);
		goto IL_0e9a;
	}
...
extern "C" void SFXPlayer_PlayRandom_m3221 (SFXPlayer_t596 * __this, SFXTypeU5BU5D_t595* ___types, float ___delay, const MethodInfo* method)
{
	...
	{
		SFXTypeU5BU5D_t595* L_0 = ___types;
		NullCheck(L_0);
		int32_t L_1 = Random_Range_m3537(NULL /*static, unused*/, 0, (((int32_t)(((Array_t *)L_0)->max_length))), /*hidden argument*/NULL);
		V_0 = L_1;
		AudioSourceU5BU5D_t594* L_2 = (__this->___audioSources_2);
		SFXTypeU5BU5D_t595* L_3 = ___types;
		int32_t L_4 = V_0;
		NullCheck(L_3);
		IL2CPP_ARRAY_BOUNDS_CHECK(L_3, L_4);
		int32_t L_5 = L_4;
		...
		V_1 = (*(AudioSource_t570 **)(AudioSource_t570 **)SZArrayLdElema(L_2, L_6));
		AudioSource_t570 * L_7 = V_1;
		float L_8 = ___delay;
		NullCheck(L_7);
		AudioSource_PlayDelayed_m4062(L_7, L_8, /*hidden argument*/NULL);
		return;
	}
}
