...
// TimeController
struct  TimeController_t469  : public MonoBehaviour_t67
{
	// TimeController/PauseChangedEventHandler TimeController::PauseChanged
	PauseChangedEventHandler_t468 * ___PauseChanged_3;
	// System.Boolean TimeController::<paused>k__BackingField
	bool ___U3CpausedU3Ek__BackingField_4;
};
struct TimeController_t469_StaticFields{
	// TimeController TimeController::instance
	TimeController_t469 * ___instance_2;
};
