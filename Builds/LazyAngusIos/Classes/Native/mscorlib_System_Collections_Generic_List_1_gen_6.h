...
struct  List_1_t625  : public Object_t
{
	// T[] System.Collections.Generic.List`1<GoogleMobileAdBanner>::_items
	GoogleMobileAdBannerU5BU5D_t5444* ____items_1;
...
struct List_1_t625_StaticFields{
	// T[] System.Collections.Generic.List`1<GoogleMobileAdBanner>::EmptyArray
	GoogleMobileAdBannerU5BU5D_t5444* ___EmptyArray_4;
};
