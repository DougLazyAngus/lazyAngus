...
// Parse.PlatformHooks
struct  PlatformHooks_t1354  : public Object_t
{
	// System.String Parse.PlatformHooks::osVersion
	String_t* ___osVersion_2;
};
struct PlatformHooks_t1354_StaticFields{
