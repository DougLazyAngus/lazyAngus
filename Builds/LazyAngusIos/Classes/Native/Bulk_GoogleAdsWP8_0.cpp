...
extern "C" AdManager_t730 * AdManager_get_instance_m3796 (Object_t * __this /* static, unused */, const MethodInfo* method)
{
	...
	bool V_1 = false;
	{
		AdManager_t730 * L_0 = ((AdManager_t730_StaticFields*)AdManager_t730_il2cpp_TypeInfo_var->static_fields)->____instance_10;
		V_1 = ((((int32_t)((((Object_t*)(AdManager_t730 *)L_0) == ((Object_t*)(Object_t *)NULL))? 1 : 0)) == ((int32_t)0))? 1 : 0);
		bool L_1 = V_1;
		if (L_1)
		{
			goto IL_001c;
...
IL_001c:
	{
		AdManager_t730 * L_3 = ((AdManager_t730_StaticFields*)AdManager_t730_il2cpp_TypeInfo_var->static_fields)->____instance_10;
		V_0 = L_3;
		goto IL_0024;
	}
