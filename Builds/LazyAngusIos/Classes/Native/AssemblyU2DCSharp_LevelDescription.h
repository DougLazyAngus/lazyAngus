...
// LevelDescription
struct  LevelDescription_t534  : public Object_t
{
	...
	List_1_t528 * ___explicitMouseDescs_1;
	// UnityEngine.Sprite LevelDescription::sprite
	Sprite_t473 * ___sprite_2;
	// TipConfig LevelDescription::tipConfig
	TipConfig_t474 * ___tipConfig_3;
