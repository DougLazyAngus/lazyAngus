...
#define DLL_EXPORT __declspec(dllexport)
	...
	DECL_USER_FUNC(_instaShare);
	DECL_USER_FUNC(_MSP_TwPost);
	DECL_USER_FUNC(_MSP_TwPostWithMedia);
	DECL_USER_FUNC(_MSP_FbPost);
	DECL_USER_FUNC(_MSP_FbPostWithMedia);
	...
	DECL_USER_FUNC(LogInIOS);
	DECL_USER_FUNC(CanLaunchURL);
}
DLL_EXPORT void RegisterMonoModules()
{
	...
	REGISTER_USER_FUNC(_instaShare);
	REGISTER_USER_FUNC(_MSP_TwPost);
	REGISTER_USER_FUNC(_MSP_TwPostWithMedia);
	REGISTER_USER_FUNC(_MSP_FbPost);
	REGISTER_USER_FUNC(_MSP_FbPostWithMedia);
	...
	REGISTER_USER_FUNC(LogInIOS);
	REGISTER_USER_FUNC(CanLaunchURL);
}
