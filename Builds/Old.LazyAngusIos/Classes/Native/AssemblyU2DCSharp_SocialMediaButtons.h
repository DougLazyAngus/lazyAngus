...
// SocialMediaButtons
struct  SocialMediaButtons_t505  : public MonoBehaviour_t67
{
...
struct SocialMediaButtons_t505_StaticFields{
	// UnityEngine.Events.UnityAction SocialMediaButtons::<>f__am$cache2
	UnityAction_t420 * ___U3CU3Ef__amU24cache2_4;
	// UnityEngine.Events.UnityAction SocialMediaButtons::<>f__am$cache3
	UnityAction_t420 * ___U3CU3Ef__amU24cache3_5;
};
