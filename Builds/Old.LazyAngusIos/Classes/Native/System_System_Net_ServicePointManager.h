...
struct  ServicePointManager_t1573  : public Object_t
{
};
struct ServicePointManager_t1573_StaticFields{
	// System.Collections.Specialized.HybridDictionary System.Net.ServicePointManager::servicePoints
	HybridDictionary_t1440 * ___servicePoints_0;
	...
	RemoteCertificateValidationCallback_t1474 * ___server_cert_cb_9;
};
