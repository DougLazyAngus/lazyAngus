...
struct  ExtendedKeyUsageExtension_t2166  : public X509Extension_t1721
{
	// System.Collections.ArrayList Mono.Security.X509.Extensions.ExtendedKeyUsageExtension::keyPurpose
	ArrayList_t1451 * ___keyPurpose_3;
};
struct ExtendedKeyUsageExtension_t2166_StaticFields{
	...
	Dictionary_2_t154 * ___U3CU3Ef__switchU24map14_4;
};
