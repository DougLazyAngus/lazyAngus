...
struct ThreadSafeDictionaryValueFactory_2_t1268;
...
struct  ThreadSafeDictionary_2_t1269  : public Object_t
{
	...
	ThreadSafeDictionaryValueFactory_2_t1268 * ____valueFactory_1;
	...
	Dictionary_2_t3940 * ____dictionary_2;
};
